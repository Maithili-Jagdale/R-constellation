! function() {
    ...
    function d(d, $) {
        ...
        for (; d.length && (n = d.shift());) d.length || void 0 === $ ? t = t[n] && t[n] !== Object.prototype[n] ? t[n] : t[n] = {} : t[n] = $
    }

    function $(d, r) {
        function $() {}
        $.prototype = r.prototype, d.o = r.prototype, d.prototype = new $, (d.prototype.constructor = d).aa = function(d, $, n) {
    ...
    var u = Array.prototype.indexOf ? function(d, $, n) {
        ...
        if (n = null == n ? 0 : n < 0 ? Math.max(0, d.length + n) : n, t(d)) return t($) && 1 == $.length ? d.indexOf($, n) : -1;
        for (; n < d.length; n++)
            if (n in d && d[n] === $) return n;
        return -1
    };
    ...
    function S(d, $) {
        ...
        if (d.h) {
            if ($ in d.c) return d.c[$];
            var t = d.h,
                e = d.g[$];
            if (null != n)
                if (e.h) {
                    for (var r = [], u = 0; u < n.length; u++) r[u] = t.c(e, n[u]);
                    n = r
                } else n = t.c(e, n);
            return d.c[$] = n
        }
    ...
    function m(d, $) {
        if (null != d.a[$]) d = b(d, $, void 0);
        else d: {
            if (void 0 === (d = d.g[$]).g)
                if (($ = d.m) === Boolean) d.g = !1;
                else if ($ === Number) d.g = 0;
            else {
                if ($ !== String) {
                    d = new $;
                    break d
    ...
    function y(d, $, n) {
        d.a[$] || (d.a[$] = []), d.a[$].push(n), d.c && delete d.c[$]
    }
    ...
    g.prototype.has = function(d) {
        ...
        return d != this && (d.a = {}, d.c && (d.c = {}), function d($, n) {
            for (var t = h($.f()), e = 0; e < t.length; e++) {
                ...
                if (null != n.a[u]) {
                    ...
                    if (r.h) {
                        r = M(n, u);
                        for (var a = 0; a < r.length; a++) y($, u, i ? r[a].clone() : r[a])
                    } else r = S(n, u), i ? (i = S($, u)) ? d(i, r) : A($, u, r.clone()) : A($, u, r)
                }
            }
        }(d, this)), d
        ...
        if (11 == d.c || 10 == d.c) return $ instanceof g ? $ : this.a(d.m.prototype.f(), $);
        if (14 == d.c) return t($) && I.test($) && 0 < (d = Number($)) ? d : $;
        if (!d.l) return $;
        if ((d = d.m) === String) {
            if ("number" == typeof $) return String($)
        } else if (d === Number && t($) && ("Infinity" === $ || "-Infinity" === $ || "NaN" === $ || I.test($))) return Number($);
        return $
    };
    var I = /^-?[0-9]+$/;
    ...
    $(G, E), G.prototype.a = function(d, $) {
        return (d = new d.c).h = this, d.a = $, d.c = {}, d
    }, $(_, G), _.prototype.c = function(d, $) {
        return 8 == d.c ? !!$ : E.prototype.c.apply(this, arguments)
    }, _.prototype.a = function(d, $) {
        return _.o.a.call(this, d, $)
    }, B.prototype.c = "", B.prototype.set = function(d) {
        this.c = "" + d
    }, B.prototype.a = function(d, $, n) {
        if (this.c += String(d), null != $)
            for (var t = 1; t < arguments.length; t++) this.c += arguments[t];
        return this
    ...
    var F = {
        ...
        V = {
            ...
            GB: [, [, , "[1-357-9]\\d{9}|[18]\\d{8}|8\\d{6}", , , , , , , [7, 9, 10],
                ...
                ], , [, , "76(?:0[0-2]|2[356]|34|4[01347]|5[49]|6[0-369]|77|81|9[39])\\d{6}", , , , "7640123456", , , [10]], 1, , [, , , , , , , , , [-1]],
            ...
            GG: [, [, , "(?:1481|[357-9]\\d{3})\\d{6}|8\\d{6}(?:\\d{2})?", , , , , , , [7, 9, 10],
                ...
                [, , , , , , , , , [-1]],
                [, , "70\\d{8}", , , , "7012345678", , , [10]],
                [, , "56\\d{8}", , , , "5612345678", , , [10]], "GG", 44, "00", "0", , , "0|([25-9]\\d{5})$", "1481$1", , , , , [, , "76(?:0[0-2]|2[356]|34|4[01347]|5[49]|6[0-369]|77|81|9[39])\\d{6}", , , , "7640123456", , , [10]], , , [, , , , , , , , , [-1]],
                [, , "(?:3[0347]|55)\\d{8}", , , , "5512345678", , , [10]], , , [, , , , , , , , , [-1]]
            ],
            ...
            HK: [, [, , "8[0-46-9]\\d{6,7}|9\\d{4}(?:\\d(?:\\d(?:\\d{4})?)?)?|(?:[235-79]\\d|46)\\d{6}", , , , , , , [5, 6, 7, 8, 9, 11]],
                ...
                [, , "(?:46(?:[01][0-6]|2[5-9]|4[0-57-9])|5730|626[01]|707[1-5]|848[015-9]|929[03-9])\\d{4}|(?:5(?:[1-59][0-46-9]|6[0-4689]|7[0-2469])|6(?:0[1-9]|[13-59]\\d|[268][0-57-9]|7[0-79])|9(?:0[1-9]|1[02-9]|[2358][0-8]|[467]\\d))\\d{5}", , , , "51234567", , , [8]],
                [, , "800\\d{6}", , , , "800123456", , , [9]],
            ...
            JE: [, [, , "1534\\d{6}|(?:[3578]\\d|90)\\d{8}", , , , , , , [10],
                ...
                [, , "56\\d{8}", , , , "5612345678"], "JE", 44, "00", "0", , , "0|([0-24-8]\\d{5})$", "1534$1", , , , , [, , "76(?:0[0-2]|2[356]|34|4[01347]|5[49]|6[0-369]|77|81|9[39])\\d{6}", , , , "7640123456"], , , [, , , , , , , , , [-1]],
            ...
            MN: [, [, , "[12]\\d{7,9}|[57-9]\\d{7}", , , , , , , [8, 9, 10],
                ...
                [, , , , , , , , , [-1]],
                [, , , , , , , , , [-1]],
                [, , "712[0-79]\\d{4}|7(?:1[013-9]|[5-8]\\d)\\d{5}", , , , "75123456", , , [8]], "MN", 976, "001", "0", , , "0", , , , [
            ...
            MY: [, [, , "1\\d{8,9}|(?:3\\d|[4-9])\\d{7}", , , , , , , [8, 9, 10],
                ...
                [, , "1(?:4400|8(?:47|8[27])[0-4])\\d{4}|1(?:0(?:[23568]\\d|4[0-6]|7[016-9]|9[0-8])|1(?:[1-5]\\d\\d|6(?:0[5-9]|[1-9]\\d)|7(?:0\\d|1[01]|2[2-6]))|(?:(?:[269]|59)\\d|[37][1-9]|4[235-9])\\d|8(?:1[23]|[236]\\d|4[06]|5[7-9]|7[016-9]|8[01]|9[0-8]))\\d{5}", , , , "123456789", , , [9, 10]],
            ...
            SG: [, [, , "(?:(?:1\\d|8)\\d\\d|7000)\\d{7}|[3689]\\d{7}", , , , , , , [8, 10, 11]],
                ...
                [, , "(?:8(?:01[0-7]|[1-8]\\d\\d|9(?:[014]\\d|2[1-9]|3[0-489]|5[0-2]))|9[0-8]\\d\\d)\\d{4}", , , , "81234567", , , [8]],
    ...
    function ed(d, $) {
        for (var n, t = new B, e = d.length, r = 0; r < e; ++r) null != (n = $[(n = d.charAt(r)).toUpperCase()]) && t.a(n);
        return t.toString()
    }
    ...
    function ud(d, $, n) {
        ...
        t = m($, 1);
        var e = ad($);
        if (0 == n) return fd(t, 0, e, "");
        if (!(t in F)) return e;
        d = id(d, t, Cd(t)), $ = null != $.a[3] && 0 != b($, 3).length ? 3 == n ? ";ext=" + b($, 3) : null != d.a[13] ? b(d, 13) + m($, 3) : " ext. " + m($, 3) : "";
        d: {
        ...
        return null != d && (d = m(u = d, 2), r = new RegExp(b(u, 1)), m(u, 5), u = m(u, 4), e = 2 == n && null != u && 0 < u.length ? e.replace(r, d.replace(q, u)) : e.replace(r, d), 3 == n && (e = (e = e.replace(/^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/, "")).replace(/[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/g, "-"))), fd(t, n, e, $)
    }
    ...
    function Sd(d, $, n, t, e, r) {
        ...
        $ = new B($), null != n && (i = b(n, 11)), null == i && (i = "NonMatch");
        var u, i, a = $.toString();
        if (i = 0 == a.length ? 20 : W.test(a) ? (a = a.replace(W, ""), $.c = "", $.a($d(a)), 1) : (a = new RegExp(i), nd($), (i = 0 == (i = $.toString()).search(a) && (a = i.match(a)[0].length, !((u = i.substring(a).match(Y)) && null != u[1] && 0 < u[1].length && "0" == ed(u[1], Z)) && ($.c = "", $.a(i.substring(a)), !0))) ? 5 : 20), e && A(r, 6, i), 20 == i) return null != n && (a = "" + (i = m(n, 10)), 0 == (u = $.toString()).lastIndexOf(a, 0) && (a = new B(u.substring(a.length)), u = b(n, 1), u = new RegExp(m(u, 2)), bd(a, n, null), a = a.toString(), !Td(u, $.toString()) && Td(u, a) || 3 == hd(d, $.toString(), n, -1))) ? (t.a(a), e && A(r, 6, 10), A(r, 1, i), i) : (A(r, 1, 0), 0);
        if ($.c.length <= 2) throw Error("Phone number too short after IDD");
        d: {
    ...
    function md(d, $, n) {
        if (!rd(n) && 0 < $.length && "+" != $.charAt(0)) throw Error("Invalid country calling code");
        return Md(d, $, n, !0)
    }
    ...
    function Md($, n, d, t) {
        ...
        if (0 <= f ? (e = f + 15, "+" == n.charAt(e) && (0 < (r = n.indexOf(";", e)) ? a.a(n.substring(e, r)) : a.a(n.substring(e))), e = n.indexOf("tel:"), a.a(n.substring(0 <= e ? e + 4 : 0, f))) : a.a((0 <= (i = (u = n).search(J)) ? 0 <= (i = (u = (u = u.substring(i)).replace(Q, "")).search(X)) && (u = u.substring(0, i)) : u = "", u)), 0 < (e = (f = a.toString()).indexOf(";isub=")) && (a.c = "", a.a(f.substring(0, e))), !dd(a.toString())) throw Error("The string supplied did not seem to be a phone number");
        if (f = a.toString(), !(rd(d) || null != f && 0 < f.length && W.test(f))) throw Error("Invalid country calling code");
        f = new U, t && A(f, 5, n);
        d: {
            if (0 <= (e = (n = a.toString()).search(j)) && dd(n.substring(0, e)))
                for (var o = (r = n.match(j)).length, l = 1; l < o; ++l)
                    if (null != r[l] && 0 < r[l].length) {
                        a.c = "", a.a(n.substring(0, e)), n = r[l];
                        break d
                    }
            n = ""
        }
        0 < n.length && A(f, 3, n), e = cd($, d), n = new B, r = 0, o = a.toString();
        try {
            r = Sd($, o, e, n, t, f)
        } catch (d) {
            if ("Invalid country calling code" != d.message || !W.test(o)) throw d;
            if (0 == (r = Sd($, o = o.replace(W, ""), e, n, t, f))) throw d
        }
        if (0 != r ? (a = Cd(r)) != d && (e = id($, r, a)) : (nd(a), n.a(a.toString()), null != d ? A(f, 1, r = m(e, 10)) : t && (delete f.a[6], f.c && delete f.c[6])), n.c.length < 2) throw Error("The string supplied is too short to be a phone number");
        if (null != e && (d = new B, bd(a = new B(n.toString()), e, d), 2 != ($ = hd($, a.toString(), e, -1)) && 4 != $ && 5 != $ && (n = a, t && 0 < d.toString().length && A(f, 7, d.toString()))), ($ = (t = n.toString()).length) < 2) throw Error("The string supplied is too short to be a phone number");
        if (17 < $) throw Error("The string supplied is too long to be a phone number");
        if (1 < t.length && "0" == t.charAt(0)) {
            for (A(f, 4, !0), $ = 1; $ < t.length - 1 && "0" == t.charAt($);) $++;
            1 != $ && A(f, 8, $)
        }
        return A(f, 2, parseInt(t, 10)), f
    }

    function Td(d, $) {
        return !(!(d = "string" == typeof d ? $.match("^(?:" + d + ")$") : $.match(d)) || d[0].length != $.length)
    }
    d("intlTelInputUtils", {}), d("intlTelInputUtils.formatNumber", function($, d, n) {
        try {
            var t = H.a(),
                e = md(t, $, d),
                r = gd(t, e);
        ...
        try {
            ...
            if (!(n = null == i)) {
                if (f = "001" != r) {
                    var a = cd(t, r);
                    if (null == a) throw Error("Invalid region code: " + r);
                    var f = u != m(a, 10)
                }
                n = f
            }
