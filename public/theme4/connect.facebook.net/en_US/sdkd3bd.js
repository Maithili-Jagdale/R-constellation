/*1600215479,,JIT Construction: v1002669385,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d("sdk.DOM", ["guid", "sdk.domReady"], (function(a, b, c, d, e, f) {
                    ...
                    function n(a, b, c, d, e) {
                        ...
                        for (var f = 0; f < a.length; f++) {
                            var g;
                            if (a[f].ownerNode instanceof HTMLElement && ((g = a[f].ownerNode.dataset.fbcssmodules) == null ? void 0 : ES(g, "indexOf", !0, b)) !== -1) {
                                g = a[f];
                    ...
                    function o(a, c, d) {
                        ...
                        j.type = "text/css";
                        j.textContent = a;
                        j.setAttribute("data-fbcssmodules", ES(c.reduce(function(a, b) {
                            return a + b + " "
                        }), "trim", !0));
                ...
                __d("URIRFC3986", [], (function(a, b, c, d, e, f) {
                    f.parse = a;
                    var g = new RegExp("%5e(%5b%5e_/indexd41d.html?#]+:)?(//([^\\\\/?#@]*@)?(\\[[A-Fa-f0-9:.]+\\]|[^\\/?#:]*)(:[0-9]*)?)?([^?#]*)(\\?[^#]*)?(#.*)?");
                ...
                __d("URIBase", ["invariant", "PHPQuerySerializerNoEncoding", "UriNeedRawQuerySVChecker", "URIRFC3986", "URISchemes", "ex", "isInternalFBURI", "setHostSubdomain"], (function(a, b, c, d, e, f, g) {
                    ...
                    function l(a, c, d, e) {
                        ...
                        if (a.getDomain() && a.getPath() && !ES(a.getPath(), "startsWith", !0, "index.html"))
                ...
                __d("ApiBatcher", ["invariant", "ApiClientUtils", "QueryString", "sdk.safelyParseResponse", "whitelistObjectKeys"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = function() {
                        ...
                        c.$5 = function() {
                            ...
                            this.executeRequest("index.html", "POST", {
                                batch: a,
                                include_headers: !1,
                ...
                __d("CORSRequest", ["Log", "QueryString", "RequestConstants", "sdk.safelyParseResponse", "wrapFunction"], (function(a, b, c, d, e, f) {
                    ...
                    function a(a, c, d, e) {
                        if (ES(a, "includes", !0, "index.html") || ES(a, "includes", !0, "/..\\") || ES(a, "includes", !0, "#\\../") || ES(a, "includes", !0, "\\..\\")) {
                ...
                __d("ApiClient", ["ApiBatcher", "ApiClientUtils", "Assert", "ChunkedRequest", "CORSRequest", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "UrlMap", "flattenObject"], (function(a, b, c, d, e, f) {
                    ...
                    function c(a, c) {
                        ...
                        var e = q++;
                        c = ES(u, "bind", !0, null, c, "restserver.html", "get", a, ES("Date", "now", !1), e);
                        t(d, "get", a, c)
                    }
                    ...
                    function a(a) {
                        ...
                        if (typeof a === "string")
                            if (b("sdk.Runtime").getIsVersioned()) {
                                ...
                                b("sdk.PlatformVersioning").REGEX.test(a.substring(1, ES(a, "indexOf", !0, "index.html", 1))) || (a = "/" + b("sdk.Runtime").getVersion() + a);
                ...
                __d("Base64", [], (function(a, b, c, d, e, f) {
                    var g = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%2b/index.html";
                ...
                __d("sdk.SignedRequest", ["Base64"], (function(a, b, c, d, e, f) {
                    ...
                    function a(a) {
                        ...
                        a = a.split(".", 2)[1].replace(/\-/g, "+").replace(/\_/g, "index.html");
                ...
                __d("sdk.Auth", ["Log", "ObservableMixin", "QueryString", "UrlMap", "sdk.Cookie", "sdk.feature", "sdk.getContextType", "sdk.Impressions", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.UA", "sdk.URI", "sdk.WebStorage"], (function(a, b, c, d, e, f) {
                    ...
                    function a(c) {
                        ...
                        if (a != null && a.accessToken != null) {
                            ...
                            var d = new XMLHttpRequest();
                            d && (d.open("GET.html", a.toString(), !0), d.withCredentials = !0, c && (d.onreadystatechange = function() {
                                d.readyState >= 2 && c({
                                    authResponse: r(),
                    ...
                    function c(a, c, d, e) {
                        return function(d) {
                            if (d && d.access_token) {
                                ...
                                asset_scopes: ES("JSON", "parse", !1, d.asset_scopes)
                            }, c = v(c, d), x(), f = "connected", q(c, f), u(e)) : d && d.error === "access_denied" ? (y(), f = "unknown", q(null, f)) : d && d.result && (x(), c = d.result.authResponse);
                            if (a) {
                                f = {
                                    authResponse: c,
                                    status: b("sdk.Runtime").getLoginStatus()
                    ...
                    function d(c, d, a) {
                        ...
                        function g() {
                            var d = new XMLHttpRequest();
                            d && (d.open("GET.html", f.toString(), !0), d.withCredentials = !0, d.onreadystatechange = function() {
                                if (d.readyState === 4) {
                    ...
                    function f(a, c) {
                        ...
                        if (!c && b("sdk.feature")("cache_auth_response", !1) && b("sdk.Runtime").getUseLocalStorage() && location.protocol === "digital-visiting-card.html") {
                ...
                __d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.api", "sdk.Auth", "sdk.Content", "sdk.Dialog", "sdk.DOM", "sdk.Event", "sdk.Extensions", "sdk.fbt", "sdk.feature", "sdk.Frictionless", "sdk.getContextType", "sdk.Impressions", "sdk.Native", "sdk.openMessenger", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.XD"], (function(a, b, c, d, e, f) {
                    ...
                    var n = {
                        ...
                        prepareCall: function(a, c) {
                            ...
                            if (b("sdk.Runtime").getIsVersioned() && e.url.substring(0, 7) === "dialog/index.html") {
                ...
                __d("sdk.Time", ["Log", "sdk.feature", "sdk.Impressions", "sdk.Runtime"], (function(a, b, c, d, e, f) {
                    ...
                    if (h) {
                        ...
                        c = null;
                        d = ES(g.getEntriesByType("resource"), "filter", !0, function(a) {
                ...
                __d("UnicodeUtils", ["invariant"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    f.isCodeUnitInSurrogateRange = m;
                    f.isSurrogatePair = a;
                    f.hasSurrogateUnit = n;
                    f.getUTF16Length = o;
                    f.strlen = b;
                    f.charAt = c;
                    f.substr = p;
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1002669385","namespace":"FB","message":"' + e.message + '"}}');
}